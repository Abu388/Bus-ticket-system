...
function AvailableSpots() {
  ...
  // you can also send booking data to backend here if needed
};
    ...
    <div className="available-spots-container">
      ...
      <section className="passenger-form-section">
        ...
        <form onSubmit={handleSubmit} className="passenger-form">
          ...
          <button type="submit" className="submit-button" onClick={handleConfirmBooking}>
            Confirm Booking
          </button>
      ...
      {bookingData && (
        <div className="booking-status" style={{
          ...
          {bookingSubmitted && (!bookingData.status || bookingData.status === 'pending') && (
